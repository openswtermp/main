...
def process(watermelon_img_path='assets/watermelon.png', landmark_model_path='shape_predictor_68_face_landmarks.dat'):
    # 오렌지 이미지 불러오기 및 크기 조정
    watermelon_img = cv2.imread(watermelon_img_path)
    watermelon_img = cv2.resize(watermelon_img, (512, 512))
